...
const GameOver: React.FC<GameOverProps> = ({ score, onReset, badges }) => {
  const shareResults = () => {
    ...
    const text = `I just completed the ${config.title} with a score of ${score} and earned ${badges.length} ${badgeText}! Create your own quest here https://github.com/gmickel/typescript-quest or try to beat my score?`;
